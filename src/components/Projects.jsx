...
const ProjectCard = ({ project }) => {
  ...
  return (
    <div id="projects" className="rounded-lg shadow-lg bg-white w-64 m-4">
      <Link to={'/projects/' + project.id} className="no-underline" style={{color:"#317187"}}>
        <img
          ...
          >
            ...
            <div>
              {expired ? (
                ...
                <small style={{color:"#317187"}} className="text-gray-500">Open</small>
              ) : project?.status == 1 ? (
